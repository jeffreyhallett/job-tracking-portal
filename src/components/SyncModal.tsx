      ...
      <div className="flex flex-col gap-3">
        <details className="card">
          ...
          <div className="px-3 pb-3 flex flex-col gap-2">
            <pre className="whitespace-pre-wrap font-mono text-[11.5px] leading-[1.45] text-fg-2 bg-surface-2 rounded-sm p-3 max-h-48 overflow-y-auto">{CLAUDE_PROMPT}</pre>
...
function Section({ title, children, collapsed = false }: { title: string; children: React.ReactNode; collapsed?: boolean }) {
  return (
    <details open={!collapsed} className="card">
